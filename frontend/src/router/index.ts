    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'AiCapabilityCenterSettingsView',
          meta: { title: '系统设置' },
          component: () => import('@/apps/ai-capability-center/views/AiCapabilityCenterView.vue'),
        },
        {
