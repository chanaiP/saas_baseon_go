...
func operationPermissionByRoute() map[string]string {
	return map[string]string{
		...
		"POST /api/ai-geo/external-sources/extract":                       "ai_geo:data:import",
		"POST /api/ai-geo/style-templates":                                "ai_geo:data:import",
		"PUT /api/ai-geo/style-templates/:id":                             "ai_geo:data:import",
		"DELETE /api/ai-geo/style-templates/:id":                          "ai_geo:data:import",
		"POST /api/ai-geo/materials/imports":                              "ai_geo:data:import",
		"POST /api/ai-geo/workbench/drafts/generate":                      "ai_geo:workbench:generate",
		"POST /api/ai-geo/workbench/ai-stream":                            "ai_geo:workbench:generate",
		...
		"POST /api/ai-geo/channel-contents/ai-editor-stream":              "ai_geo:channel_content:manage",
		...
		"PUT /api/ai-geo/channels/:id":                                    "ai_geo:channel:manage",
		"POST /api/ai-geo/channels/:id/test":                              "ai_geo:channel:manage",
...
func menuPermissionByRoute() map[string]string {
	return map[string]string{
		...
		"/api/ai-geo/style-templates":                               "/ai-geo/data/products",
		"/api/ai-geo/style-templates/:id":                           "/ai-geo/data/products",
		...
		"/api/ai-geo/publish-plans/calendar":                        "/ai-geo/plans/calendar",
