...
func openAPISpec() gin.H {
	...
	return withOpenAPISchemas(gin.H{
		...
		"paths": gin.H{
			...
			"/api/ai-geo/materials/brands/{id}":                          gin.H{"put": api("ai-geo", "更新品牌资料卡"), "delete": api("ai-geo", "归档品牌资料卡")},
			"/api/ai-geo/materials/products":                             gin.H{"get": api("ai-geo", "商品资料卡列表"), "post": api("ai-geo", "创建商品资料卡")},
			"/api/ai-geo/materials/products/{id}":                        gin.H{"put": api("ai-geo", "更新商品资料卡"), "delete": api("ai-geo", "归档商品资料卡")},
			"/api/ai-geo/materials/skus":                                 gin.H{"get": api("ai-geo", "SKU 资料列表"), "post": api("ai-geo", "创建 SKU 资料")},
			"/api/ai-geo/materials/skus/{id}":                            gin.H{"put": api("ai-geo", "更新 SKU 资料"), "delete": api("ai-geo", "归档 SKU 资料")},
			"/api/ai-geo/materials/competitors":                          gin.H{"get": api("ai-geo", "竞品资料列表"), "post": api("ai-geo", "创建竞品资料")},
			"/api/ai-geo/materials/competitors/{id}":                     gin.H{"put": api("ai-geo", "更新竞品资料"), "delete": api("ai-geo", "归档竞品资料")},
