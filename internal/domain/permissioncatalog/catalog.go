...
func OperationName(path string) string {
	names := map[string]string{
		...
		"business_unit:relation_manage":      "业务单元-关系维护",
		"business_unit:actor_manage":         "业务单元-责任方维护",
		"business_unit:attr_template_manage": "业务单元-属性模板",
		"user:create":                        "用户-新增",
		"user:edit":                          "用户-编辑",
...
func OperationLabel(path string) string {
	...
	actionLabel := map[string]string{
		...
		"quota_config":           "调整配额",
		"permission":             "权限设置",
		"relation_manage":        "关系维护",
		"actor_manage":           "责任方维护",
		"attr_template_manage":   "属性模板",
	}
	if ok {
