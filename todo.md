...
- [ ] 实现资料中心 API：品牌、商品、SKU、竞品、关键词/素材的列表、详情、新增、更新、归档。（已完成品牌/商品/SKU/竞品基础列表、新增、更新、归档；待补详情、关键词/素材）
...
- [ ] 补 service 单测：资料校验、状态机、配额拒绝、AI 失败降级、发布计划流转。（已完成租户隔离、母稿状态机、跨租户拒绝、审计上下文、配额拒绝与月度扣减、AI Gateway 母稿/渠道/审核建议解析、资料导入预校验/部分成功/幂等落库）
