...
- [ ] 实现资料中心 API：品牌、商品、SKU、竞品、关键词/素材的列表、详情、新增、更新、归档。（已完成品牌/商品/SKU/竞品/素材/热点列表、详情、新增、更新、归档；待补独立关键词 API）
...
- [ ] 实现发布计划 API：日历、队列、创建、调整时间、标记已发布、失败重试、发布链接回填。（已完成列表/队列、创建、调整时间、标记已发布、失败重试、发布链接回填、状态机校验和渠道内容状态同步；待补日历聚合接口）
...
- [ ] 补 service 单测：资料校验、状态机、配额拒绝、AI 失败降级、发布计划流转。（已完成租户隔离、资料详情跨租户拒绝、母稿状态机/详情/归档、渠道内容编辑/审核/跨租户拒绝、审计上下文、配额拒绝与月度扣减、AI Gateway 母稿/渠道/审核建议解析、资料导入预校验/部分成功/幂等落库、素材/热点详情/更新/租户隔离、发布计划调整/失败重试/发布状态同步、工作台 SKU/热点上下文）
